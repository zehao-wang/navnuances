            ...
            while True:
                for traj in self.rollout(**kwargs):
                    if traj['instr_id'] in self.results:
                        ...
                        for item in preds_detail:
                            for ii, datum in enumerate(item['llm_observation']):
                                if isinstance(datum, str):
                                    item['llm_observation'][ii] = datum
                                    continue
                                ...
                                for dd in datum:
                                    if dd[0] == 'text':
                                        ...
                                        import ipdb;ipdb.set_trace() # breakpoint 70
                                item['llm_observation'][ii] = feature


                            for datum in item['details']:
                                feature = []
                                for feat in datum['feature']:
                                    if feat[0] == 'text':
                                        feature.append(feat)
