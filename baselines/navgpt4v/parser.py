...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str, default='../datasets/R2R/exprs/gpt-4v', help='experiment id')
    parser.add_argument('--seed', type=int, default=0)

    # Agent
    parser.add_argument('--temperature', type=float, default=0.0, help='temperature for llm')
    parser.add_argument('--llm_model_name', type=str, default='gpt-4-turbo', help='llm model name')
...
def postprocess_args(args):
    ...
    args.connectivity_dir = './connectivity'
